...
<head>
    <meta charset="utf-8">
    <link href="{{ asset('assets/admin/dist/images/logo.svg') }}" rel="shortcut icon">
        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                <a href="" class="-intro-x flex items-center pt-5">
                    ...
                    <span class="text-white text-lg ml-3"><span class="font-medium">ADMINISTRATOR</span> </span>
                </a>
            </div>
            <!-- END: Login Info -->
            <!-- BEGIN: Login Form -->
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div
                    ...
                    <form method="post" action="{{ url('admins/dologin') }}">
                        @csrf
                        ...
                        <div class="intro-x flex text-gray-700 dark:text-gray-600 text-xs sm:text-sm mt-4">
                            <div class="cursor-pointer select-none" for="remember-me">Email :
                                testing@testing.com
                            </div>
                        </div>
                        <div class="intro-x flex text-gray-700 dark:text-gray-600 text-xs sm:text-sm mt-4">
                            <div class="cursor-pointer select-none" for="remember-me">Password
                                :
                                password
                            </div>
                        </div>
